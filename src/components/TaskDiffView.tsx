...
const diffStyles = {
  variables: {
    dark: {
      diffViewerBackground: 'var(--awt-bg)',
      diffViewerColor: 'var(--awt-text)',
      ...
      gutterBackground: 'var(--awt-panel)',
      gutterBackgroundDark: 'var(--awt-panel)',
      highlightBackground: 'var(--awt-input)',
      codeFoldGutterBackground: 'var(--awt-panel)',
      codeFoldBackground: 'var(--awt-panel)',
      emptyLineBackground: 'var(--awt-bg)',
      gutterColor: 'var(--awt-muted)',
      addedGutterBackground: 'rgba(46, 160, 67, 0.18)',
      removedGutterBackground: 'rgba(248, 81, 73, 0.18)',
      codeFoldContentColor: 'var(--awt-muted)',
    },
  },
}
