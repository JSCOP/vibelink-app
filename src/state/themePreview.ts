...
export function applyThemeToDocument(themeId: string, selectedPaneHighlightColor: string, alarmHighlightColor: string, reviewedPaneHighlightColor: string): void {
  ...
  root.style.setProperty('--vibelink-reviewed-pane-highlight', reviewedPaneHighlightColor)
}
