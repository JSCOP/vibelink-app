...
export const keybindingDefinitions: KeybindingDefinition[] = [
  ...
  { id: 'moveLeft', label: 'Move pane left', description: 'Move the active pane one position to the left.' },
  { id: 'moveRight', label: 'Move pane right', description: 'Move the active pane one position to the right.' },
  { id: 'moveUp', label: 'Move pane up', description: 'Move the active pane one position up.' },
  { id: 'moveDown', label: 'Move pane down', description: 'Move the active pane one position down.' },
