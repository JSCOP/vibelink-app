...
export const keybindingDefinitions: KeybindingDefinition[] = [
  ...
  { id: 'toggleWorkspaces', label: 'Toggle Workspaces panel', description: 'Open the Workspaces panel or close the left sidebar when it is already active.' },
  { id: 'toggleLeftSidebar', label: 'Toggle left sidebar', description: 'Open or close the left structural sidebar.' },
  ...
  { id: 'terminalSearch', label: 'Find in terminal', description: 'Search the active terminal pane buffer. Replaces the shell forward-character binding while VibeLink is focused.' },
  { id: 'openCommandPalette', label: 'Command palette', description: 'Switch workspace, open content, spawn a terminal, or run a command from one search box.' },
