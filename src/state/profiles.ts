...
export type Settings = {
  ...
  stopTerminalsOnAppExit: boolean
...
export function normalizeSettings(value: unknown): Settings {
  ...
  return {
    ...
    stopTerminalsOnAppExit: readBoolean(record?.stopTerminalsOnAppExit, defaultSettings.stopTerminalsOnAppExit),
